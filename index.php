...
<header id="header-key" class="header-key">
    ...
    <div class="container contetn-center ">
        ...
        <div class="row content-header-top-z ">
            <div class="col-md-6 right-header-content">
                <h1>THE KEY</h1>
            ...
            <div class="img-parlex-right" style="background-image: url('img/img1.jpg')">
                <div class="row right-box-big-khzoog">
                    ...
                    <a href="the-pillars-of-islam.php" class="col height-top back-1" data-1500=""
                        ...
                        <h5>
                            <span class="text text-uppercase">Prayer</span>
                    ...
                    <a href="the-pillars-of-islam.php" class="col height-top back-4" data-1500=""
                        ...
                        <h5>
                            ...
                            <span class="hover text-uppercase">Charity</span>
                        </h5>
                    </a>
                </div>
            </div>
            ...
            <div class="text-content">
                ...
                <p class="sum-dit sum-det-custom  wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.8s"
                   data-1600="" data-1700="">
                    The Ka'bah
                    The Black Stone<br>
                    Station of Abraham<br>
                    The Well of Zamzam<br>
                    Safaa and Marwaa<br>
                    Jamaraat<br>
                    Muslim’s Eid Celebrations<br>
                    The Prophet’s Masjid<br>
                    Mount Hiraa
        ...
        <div class="row z-index-105 padding-50px-y">
            <div class="col padding-left-150px padding-right-60px-custom">
                <h1 class="the-title" data-1900=""
                    data-2100="">Etiquette, Manners, and Morals in Islam</h1>
                <p class="the-des-home" data-1900=""
                   data-2100=""> Islam forbids all evil and licentious acts, whether in
                    speech or deed.</p>
                <div class="img-responsove-center" style="background-image: url('img/imgvideo.jpg');"></div>
            </div>
        </div>
    </div>
...
<section class="the-end">
    ...
    <div class="row z-index-105">
        ...
        <div class="col-md-6 padding-left-50px">
