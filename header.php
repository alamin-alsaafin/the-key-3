<div id="scroll-fix">
    <div class="main-header position-relative">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:void(0)">Learn About Islam</a>
                                <ul>
                                    ...
                                    <li><a href="What-is-Islam.php#What_do_they_say_about_Islam">What do they say about
                                            Islam?</a></li>
        ...
        <div class="two-top">
            <span class="language-btn search-btn">
                <button id="btn-langs" class="btn--langs"><i class="fas fa-globe"></i></button>
                <div class="lang-content">
                    <ul class="list-unstyled">
                        ...
                        <li class=""><a href=""><b>NL</b><span>Nederlands</span></a></li>
                        <li class=" "><a href=""><b>PT</b><span>português</span></a></li>
    ...
    <div class="topheader"><a href="index.php"><img src="img/key.png" alt=""></a></div>
</div>
<!-- Modal -->
