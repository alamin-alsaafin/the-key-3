...
.gsc-control-cse
{
    ...
    background: none !important;
    background: rgb(31, 42, 43) !important;
    height: 80px !important;
    border: none !important;
    border-bottom: 1px #32a5aa solid !important;
...
.gsc-search-button-v2, .gsc-search-button-v2:hover, .gsc-search-button-v2:focus {
    border-color: #1f2a2b !important;
    background-color: #1f2a2b !important;
